...
Your blessings and prayer list are stored locally within the app on your device. They may also be included in Apple backups you choose to make.

### Does the app require an account?

No. Thanksgiving Journal does not require an account or sign-in.

### How do I change the text for the Everyday Blessing?

Open **Settings**, edit the Everyday Blessing text, and tap **Save**. You can select **Restore Original Default** at any time.

### How do I delete my journal data?
...
Please do not include private journal entries or prayer-list information.

[Read the Thanksgiving Journal Privacy Policy](/thanksgiving-journal/privacy/).
